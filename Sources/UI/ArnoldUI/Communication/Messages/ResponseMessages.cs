...
public sealed class ObserverResult : Table {
  public static ObserverResult GetRootAsObserverResult(ByteBuffer _bb) { return GetRootAsObserverResult(_bb, new ObserverResult()); }
  public static ObserverResult GetRootAsObserverResult(ByteBuffer _bb, ObserverResult obj) { return (obj.__init(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public ObserverResult __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static Offset<ObserverResult> CreateObserverResult(FlatBufferBuilder builder,
    ...
    builder.StartObject(2);
    ObserverResult.AddData(builder, dataOffset);
    ObserverResult.AddObserver(builder, observerOffset);
    return ObserverResult.EndObserverResult(builder);
  }

  public static void StartObserverResult(FlatBufferBuilder builder) { builder.StartObject(2); }
  ...
  public static Offset<ObserverResult> EndObserverResult(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<ObserverResult>(o);
  }
};
...
public sealed class ModelResponse : Table {
  ...
  public ObserverResult GetObserverResults(int j) { return GetObserverResults(new ObserverResult(), j); }
  public ObserverResult GetObserverResults(ObserverResult obj, int j) { int o = __offset(32); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  public int ObserverResultsLength { get { int o = __offset(32); return o != 0 ? __vector_len(o) : 0; } }
  ...
  public static Offset<ModelResponse> CreateModelResponse(FlatBufferBuilder builder,
      ...
      VectorOffset observerResultsOffset = default(VectorOffset)) {
    builder.StartObject(15);
    ModelResponse.AddObserverResults(builder, observerResultsOffset);
  ...
  public static void AddObserverResults(FlatBufferBuilder builder, VectorOffset observerResultsOffset) { builder.AddOffset(14, observerResultsOffset.Value, 0); }
  public static VectorOffset CreateObserverResultsVector(FlatBufferBuilder builder, Offset<ObserverResult>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static void StartObserverResultsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
